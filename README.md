...
- A GPU-accelerated 3D timeline from 2026–3026 CE with switchable measured layers: the 42.49 mas, 3690 K near-infrared photosphere and the larger 57.74 mas, approximately 2300 K ALMA Band 7 atmosphere. Its reduced spherical gas-flow solver evolves temperature, density, horizontal/radial velocity, buoyancy, pressure response, viscosity, thermal diffusion, compressional heating, and radiative relaxation without imposing an observationally ambiguous rigid rotation. Large-cell brightness structure and cooler intercell lanes are visible without exceeding the observed percent-level global asymmetry.
