...
- [x] The WebGL timeline provides high/efficient GPU modes, a physics-coupled convection field, a 500-year received-time axis, an observational size anchor, and an explicitly imposed short-horizon explosion branch.
- [x] The stellar surface is coupled to a reduced conservation-law gas solver with advected temperature, density, horizontal/radial velocity, pressure gradients, buoyancy, viscosity, thermal diffusion, compressional heating, and radiative relaxation.
